...
if wontchange[0] == wontchange[1]:      #checking if letter [0,0] is the same and has different case than [n-1,n-1]
    ...
    while(True):
        ...
        if pos[1] != n-1 and boolgrid[pos[0]][pos[1]+1] == 0: #right
            ...
            if char[case[0]] == case[1]:
                ...
                list.append([pos[0], pos[1]+1, depth+1])
        ...
        if pos[0] != n-1 and boolgrid[pos[0]+1][pos[1]] == 0: #down
            ...
            if char[case[0]] == case[1]:
                ...
                list.append([pos[0]+1, pos[1], depth+1])
...
def function(n, number):        #make 2^10 possibilities
    ...
    for i in range(10-n):
        ...
        if i + n == wontchange[0] or i + n == wontchange[1]: 
            function(n+1+i, number)        #não precisa alterar a letra do início e do fim, tornando 2^8
            return 0
        char[n+i] = 2
        # print(char)
